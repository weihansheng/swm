...
public class ProgressWheel extends View {
	...
	private void parseAttributes(TypedArray a) {
		...
		spinSpeed = (int) countSpeed(a.getDimension(R.styleable.ProgressWheel_spinSpeed,
			spinSpeed));
		delayMillis = (int)countSpeed( a.getInteger(R.styleable.ProgressWheel_delayMillis,
			delayMillis));
		if(delayMillis<0) {
			delayMillis = 0;
		}
	    ...
	    barLength = (int) countSpeed(a.getDimension(R.styleable.ProgressWheel_barLength,
	    	barLength));
