...
public class DownloadService extends Service {
	...
	private void setUpNotification() {
		int icon = R.drawable.icon_download_ing;
		...
		RemoteViews contentView = new RemoteViews(getPackageName(), R.layout.notification_download_layout);
		contentView.setTextViewText(R.id.name, "导员在线 正在下载...");
		// 指定个性化视图
